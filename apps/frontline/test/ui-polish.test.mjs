...
test("组长、部门管理员、公司管理员和总公司管理员共用指标纵向矩阵", async () => {
  const [matrix, lead, department, company, headquarters, css] = await Promise.all([
  ...
  assert.match(headquarters, /<OrgGroupMetricMatrix/);
