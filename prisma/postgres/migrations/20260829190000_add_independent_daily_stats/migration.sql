...
CREATE TYPE "DailyStatStatus" AS ENUM ('DRAFT', 'PENDING', 'RETURNED', 'APPROVED', 'CORRECTION_PENDING');
...
CREATE TABLE "DailyStatEntry" (
    ...
    "status" "DailyStatStatus" NOT NULL DEFAULT 'DRAFT',
    ...
    CONSTRAINT "DailyStatEntry_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "DailyStatRevision" (
    ...
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "DailyStatRevision_pkey" PRIMARY KEY ("id")
);
...
ALTER TABLE "DailyStatEntry" ADD CONSTRAINT "DailyStatEntry_ownerId_fkey" FOREIGN KEY ("ownerId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "DailyStatEntry" ADD CONSTRAINT "DailyStatEntry_groupId_fkey" FOREIGN KEY ("groupId") REFERENCES "TeamGroup"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "DailyStatEntry" ADD CONSTRAINT "DailyStatEntry_channelId_groupId_fkey" FOREIGN KEY ("channelId", "groupId") REFERENCES "Channel"("id", "groupId") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "DailyStatEntry" ADD CONSTRAINT "DailyStatEntry_sourceReceptionId_fkey" FOREIGN KEY ("sourceReceptionId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE "DailyStatEntry" ADD CONSTRAINT "DailyStatEntry_sourceGroupOperatorId_fkey" FOREIGN KEY ("sourceGroupOperatorId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE "DailyStatEntry" ADD CONSTRAINT "DailyStatEntry_reviewedById_fkey" FOREIGN KEY ("reviewedById") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE "DailyStatRevision" ADD CONSTRAINT "DailyStatRevision_entryId_fkey" FOREIGN KEY ("entryId") REFERENCES "DailyStatEntry"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "DailyStatRevision" ADD CONSTRAINT "DailyStatRevision_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "DailyStatEntry" ADD CONSTRAINT "DailyStatEntry_currentRevisionId_fkey" FOREIGN KEY ("currentRevisionId") REFERENCES "DailyStatRevision"("id") ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE "DailyStatEntry" ADD CONSTRAINT "DailyStatEntry_approvedRevisionId_fkey" FOREIGN KEY ("approvedRevisionId") REFERENCES "DailyStatRevision"("id") ON DELETE SET NULL ON UPDATE CASCADE;
