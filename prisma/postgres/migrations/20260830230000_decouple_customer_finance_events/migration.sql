...
CREATE TABLE "CustomerFinanceEvent" (
    ...
    CONSTRAINT "CustomerFinanceEvent_pkey" PRIMARY KEY ("id")
);

INSERT INTO "CustomerFinanceEvent" (
...
ALTER TABLE "CustomerFinanceEvent"
ADD CONSTRAINT "CustomerFinanceEvent_batchId_fkey" FOREIGN KEY ("batchId") REFERENCES "SourceBatch"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "CustomerFinanceEvent"
ADD CONSTRAINT "CustomerFinanceEvent_customerOrderId_fkey" FOREIGN KEY ("customerOrderId") REFERENCES "CustomerOrder"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "CustomerFinanceEvent"
ADD CONSTRAINT "CustomerFinanceEvent_enteredById_fkey" FOREIGN KEY ("enteredById") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "CustomerFinanceEvent"
ADD CONSTRAINT "CustomerFinanceEvent_voidedById_fkey" FOREIGN KEY ("voidedById") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
