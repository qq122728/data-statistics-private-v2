...
describe("组员业绩导出", () => {
  it("按岗位输出统一的 Excel 列，并为接粉保留有效数据与归属净业绩", () => {
    const rows = memberPerformanceReportRows({
      reception: [{ id: "r", name: "接粉 A", active: true, groupId: "g", groupName: "A组", total: 10, lowAmount: 1, noWs: 1, invalid: 1, valid: 7, replied: 5, joined: 3, left: 1, expertIntroduced: 2, expertContacted: 2, registered: 1, orders: 1, firstDepositCents: 100000, depositCents: 123400, withdrawalCents: 3400, costCents: 7000, profitCents: 113000 }],
